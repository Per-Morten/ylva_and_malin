...
SCENARIO("Stack frame allocators can allocate and deallocate aligned memory",
         "[stack_frame_allocator aligned]")
{
    GIVEN("Empty allocator")
    {
        ym::stack_frame_allocator allocator;
...
SCENARIO("Stack frame allocators can allocate and deallocate unaligned memory",
         "[stack_frame_allocator unaligned]")
{
    GIVEN("Empty allocator")
    {
        ym::stack_frame_allocator allocator;
